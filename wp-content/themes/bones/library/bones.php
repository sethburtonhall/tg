...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'flexslider', get_stylesheet_directory_uri() . '/library/js/libs/flexslider.js', array(), '2.5.3', false );
    wp_register_script( 'responsive_nav', get_stylesheet_directory_uri() . '/library/js/libs/responsive_nav.js', array(), '2.5.3', false );

    // register main stylesheet
    wp_register_style( 'bones-stylesheet', get_stylesheet_directory_uri() . '/library/css/global.css', array(), '', 'all' );
...
function tg_header_nav() {
  // display the wp3 menu if available
    wp_nav_menu(array(
      ...
      'theme_location' => 'headerNav',                 // where it's located in the theme
...
function tg_summer_adventures_page_nav() {
  // display the wp3 menu if available
    wp_nav_menu(array(
      'container' => false,                           // remove nav container
      'container_class' => 'menu clearfix',           // class of container (should you choose to use it)
      'menu' => __( 'Summer Adventures Page Nav', 'bonestheme' ),  // nav name
      'menu_class' => 'nav top-nav clearfix',         // adding custom nav class
      'theme_location' => 'mainNav',                 // where it's located in the theme
      'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
...
function tg_footer_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'theme_location' => 'footerNav',             // where it's located in the theme
    	'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
...
function bones_page_navi($before = '', $after = '') {
	...
	previous_posts_link('<span data-icon="&#xe009;"></span>');
	echo '</li>';
	...
	next_posts_link('<span data-icon="&#xe007;"></span>');
	echo '</li>';
	if ($end_page < $max_page) {
